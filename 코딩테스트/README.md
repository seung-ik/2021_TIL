...
##### 문자열 내마음대로 정렬하기 (프그 1단계) (실패)

### 03/22(월)

##### 기능개발 (프그 2단계) (실패)

- 곧이곧대로 너무 너는 더해서 해결해 남은거로도 생각해볼수 있잖아 필요한 작업을 단순화 좀 해야되
- 스택하고 큐는 추상화를 잘해야 겠다.

### 04/06(화)

##### H-index(2단계) (한번더 읽어보자)

##### 피보나치의 수 (2단계)

- 피보나치수를 동적계획법으로 풀수도 있고 메모이 제이션으로도 풀수가 있는데 이경우에는 앞에 것이 계산이 나머지 형태로 되어있어야 해서 동적계획법으로 풀어주는게 좋구나

### 04/07(수)

##### 예상대진표(2단계)

- 재귀로도 풀수 잇나 ? 나중에 한번 시도 해보자
- 사람들 왜케 똑똑하지 ㅋㅋㅋ 졸라 쉽게푸네

### 04/14(수)

##### 124나라의 숫자(2단계)

- switch 문 사용법이 익숙지가않음
- 왜 -1 을 해야하는지 완전히 이해못함
